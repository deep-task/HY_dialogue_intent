...
def talker():
    pub = rospy.Publisher('/intentExecution', String, queue_size=10)
    ...
    # publish_str_ko_home.append(
    #     '{"header": {"timestamp": "1563980674.262554407", "target": ["intent"], "content": ["dialog_intent"], "source": "planning"}, "dialog_intent": {"name": "이병현", "intent": "transmit_information_disease_advice", "id": 201, "human_speech": "짜게 먹었어", "social_context": {"disease_name":"당뇨", "disease_advice":"가벼운 음식과 싱거운 운동"}}}')
    # publish_str_ko_home.append(
    ...
    #     '{"header": {"timestamp": "1563980674.262554407", "target": ["intent"], "content": ["dialog_intent"], "source": "planning"}, "dialog_intent": {"name": "이병현", "intent": "saying_good_bye", "id": 204, "human_speech": "알겠어. 고마워.", "social_context": {}}}')
    # publish_str_ko_home.append(
    #     '{"header": {"timestamp": "1563980674.262554407", "target": ["intent"], "content": ["dialog_intent"], "source": "planning"}, "dialog_intent": {"name": "이병현", "intent": "saying_hello", "id": 205, "human_speech": "또 보는구나", "social_context": {"appellation":"할아버지"}}}')
    # publish_str_ko_home.append(
    #     '{"header": {"timestamp": "1563980674.262554407", "target": ["intent"], "content": ["dialog_intent"], "source": "planning"}, "dialog_intent": {"name": "이병현", "intent": "check_information_schedule", "id": 205, "human_speech": "잘 못 지냈어", "social_context": {"visit_place":"약국"}}}')
    # publish_str_ko_home.append(
    #     '{"header": {"timestamp": "1563980674.262554407", "target": ["intent"], "content": ["dialog_intent"], "source": "planning"}, "dialog_intent": {"name": "이병현", "intent": "transmit_information_disease_regard", "id": 206, "human_speech": "안 갔어", "social_context": {"disease_name":"당뇨","disease_status":"negative", "appellation":"할아버지"}}}')
    # publish_str_ko_home.append(
